...
"""
def ejercicio_03(principal, interes):
...
"""
def ejercicio_04(numero_a, numero_b, numero_c):
...
"""
def ejercicio_05(grados_celsius):
    ...
    print(f"{linea}")
    return(grados_farenheit,grados_kelvin)
...
def ejercicio_06(pulgadas):
    ...
    print(f"{linea}")
    return(round(pies,2), round(codos,2), round(varas,2), round(indices,2), round(orejas,2), round(jamones,2))

#7. Realiza un programa que calcule el área de un triángulo y un cuadrado.
def ejercicio_07(lado):
    ...
    print(f"{linea}")
    return(round(area_cuadrado,2),round(area_triangulo,2))
...
def ejercicio_08(peso, estatura):
...
def ejercicio_09(dividendo, divisor):
    ...
    print(f"{linea}")
    return(resultado_division_entera)
